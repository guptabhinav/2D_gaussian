...
PRINT*,'height of gaussain =',h0,'width of gaussian =',ds
...
PRINT*, 'bath Tempearture in kelvin=',bath_temp, 'and in atomic units=', au_tbath
  ...
  CALL fion_x(x,force_x,m,a,k,kb,natoms,f,au_tbath,dt,noise,mtd_step,xtau,ytau,h,ds)
  CALL fion_y(y,force_y,m,b,k,kb,natoms,f,au_tbath,dt,noise,mtd_step,xtau,ytau,h,ds)
...
!  call check_displacement(y,ytau(mtd_step),1.5d0*ds,dd,displaced)
 displaced = .false.
     ...
     mtd_step=mtd_step+1
         ...
         call eval_vbias(x,xtau,ytau,y,mtd_step,ds,h,vbias)
...
SUBROUTINE fion_x(x,force_x,m,a,k,kb,natoms,f,au_tbath,dt,noise,mtd_step,xtau,ytau,h,ds)
implicit none
REAL*8 :: x,force_x,xtau(*),ytau(*),h(*)
...
SUBROUTINE fion_y(y,force_y,m,b,k,kb,natoms,f,au_tbath,dt,noise,mtd_step,xtau,ytau,h,ds)
implicit none
REAL*8 :: y,force_y,xtau(*),ytau(*),h(*)
...
subroutine eval_vbias(x,xtau,ytau,y,mtd_step,ds,h,vbias)
implicit none
